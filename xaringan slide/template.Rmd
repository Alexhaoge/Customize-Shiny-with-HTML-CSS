---
title: "Customize Shiny UI with HTML and CSS"
author: "Zhihao Lyu"
date: Sys.Date()
output:
  xaringan::moon_reader:
    css: ["default", "css/xaringan-themer.css", "mystyle.css"]
    lib_dir: libs
...
lct = Sys.setlocale("LC_TIME", "English")
# Sys.setlocale("LC_TIME", "en_US.UTF-8") # on macOS/Linux
cat(strftime(Sys.Date(), format = "%B %d, %Y"))
```
